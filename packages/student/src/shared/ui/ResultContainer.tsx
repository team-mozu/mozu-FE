...
import type { TeamOrdersData } from "@/entities/transaction";
import { useTeamOrders } from "@/entities/transaction";
import { useTeamResult } from "@/entities/user";
import { resetShownInvDegs } from "@/pages/home/ui/HomePage";
import { roundToFixed, useSSE } from "@/shared";
import { AssetChange, History, NthDeal } from "@/shared/ui";
          ...
          <Transaction>
            ...
            {teamOrders &&
              ...
              [
                ...
                .reverse()
                .map(deg => {
                  const ordersInDeg = teamOrders.filter((order: TeamOrdersData) => order.invDeg === deg);
                  ...
                  return (
                    <NthDeal
                      ...
                      orderHistory={
                        <>
                          {ordersInDeg.reverse().map((order: TeamOrdersData, idx: number) => (
                            <History
                              key={idx}
