...
const mockNewsData = [
  {
    ...
    content: "이것은 모의 뉴스 기사입니다. 주식 시장은 기술 및 재생 에너지 부문에 힘입어 전례 없는 성장을 보였습니다. 투자자들은 미래에 대해 낙관적입니다.",
  },
  {
    id: 2,
    title: "[MOCK] AI의 새로운 혁신에 대한 보고서",
    content: "인공 지능의 획기적인 발전이 발표되어 여러 산업에 혁명을 일으킬 것으로 예상됩니다. 이 기사는 뉴스 모달 기능을 시연하기 위한 것입니다.",
  },
];
