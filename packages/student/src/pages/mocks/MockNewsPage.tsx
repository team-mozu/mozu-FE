...
const mockArticles: Article[] = [
  {
    ...
    description: "이것은 모의 뉴스 기사입니다. 주식 시장은 기술 및 재생 에너지 부문에 힘입어 전례 없는 성장을 보였습니다. 투자자들은 미래에 대해 낙관적입니다.",
    image: "https://via.placeholder.com/150x100?text=News1",
  },
  {
    articleId: 2,
    title: "[MOCK] AI의 새로운 혁신에 대한 보고서",
    description: "인공 지능의 획기적인 발전이 발표되어 여러 산업에 혁명을 일으킬 것으로 예상됩니다. 이 기사는 뉴스 모달 기능을 시연하기 위한 것입니다.",
    image: "https://via.placeholder.com/150x100?text=News2",
  },
  {
    articleId: 3,
    title: "[MOCK] 글로벌 경제 회복세",
    description: "주요 경제 지표들이 글로벌 경제의 강력한 회복세를 나타내고 있습니다. 이는 기업 실적 개선과 고용 증가로 이어질 것으로 기대됩니다.",
    image: "https://via.placeholder.com/150x100?text=News3",
  },
  {
    articleId: 4,
    title: "[MOCK] 신기술 스타트업 투자 활발",
    description: "새로운 기술을 개발하는 스타트업에 대한 투자가 활발하게 이루어지고 있습니다. 이는 미래 성장 동력 확보에 중요한 역할을 할 것입니다.",
