...
import {
  buttonWrapperStyles,
  iconCompleteWrapperStyles,
  iconContentStyles,
  iconDelWrapperStyles,
      ...
      >
        <div css={modalContainerStyles}>
          ...
          <div css={modalUpperStyles}>
            <div css={type === "complete" ? iconCompleteWrapperStyles : iconDelWrapperStyles}>
          ...
          <div css={modalLowerStyles}>
            <div css={buttonWrapperStyles}>
              ...
              <Button
                backgroundColor={type === "complete" ? color.orange[500] : color.red[500]}
                color={color.white}
